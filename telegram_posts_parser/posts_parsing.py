...
from telegram_channels import telegram_channels_to_parse

logging.basicConfig(level=logging.INFO)


OUTPUT_FILE = "../data/posts.csv"
TOTAL_POSTS_TO_FETCH = 4000
...
def main():
    ...
    posts_df.to_csv(OUTPUT_FILE)
    logging.info(f"Posts data saved to: {OUTPUT_FILE}")
